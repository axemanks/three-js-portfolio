...
const Island = ({ isRotating, setIsRotating, setCurrentStage, ...props }) => {
  ...
  useFrame(() => {
    ...
    if (!isRotating) {
      ...
      rotationSpeed.current *= dampingFactor; // gets slower and slower
      ...
      // slow island down
      islandRef.current.rotation.y += rotationSpeed.current; // apply the slow down
    } else {
  ...
  useEffect(() => {
    const canvas = gl.domElement; // attach to canvas
